...
We note here that although this is bulk data, we can still treat each sample as if it were a single cell. Although this includes some caveats, the results suggest that the approach is reasonable. 
